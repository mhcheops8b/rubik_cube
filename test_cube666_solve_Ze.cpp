...
int Ze_signum_indices[] = {
	...
	36 + 8, 36 + 9, 36 + 13, 36 + 16, 36 + 19, 36 + 22, 36 + 26, 36 + 27,
	2 * 36 + 8, 2 * 36 + 9, 2 * 36 + 13, 2 * 36 + 16, 2 * 36 + 19, 2 * 36 + 22, 2 * 36 + 26, 2 * 36 + 27,
	3 * 36 + 8, 3 * 36 + 9, 3 * 36 + 13, 3 * 36 + 16, 3 * 36 + 19, 3 * 36 + 22, 3 * 36 + 26, 3 * 36 + 27,
	4 * 36 + 8, 4 * 36 + 9, 4 * 36 + 13, 4 * 36 + 16, 4 * 36 + 19, 4 * 36 + 22, 4 * 36 + 26, 4 * 36 + 27,
	5 * 36 + 8, 5 * 36 + 9, 5 * 36 + 13, 5 * 36 + 16, 5 * 36 + 19, 5 * 36 + 22, 5 * 36 + 26, 5 * 36 + 27};

int Ze_signum(Permutation<6> &perm) {
	int sig = 1;
	for (int i =0; i < 48; i++)
	for (int j = i + 1; j < 48; j++) {
		if (perm._components[Ze_signum_indices[i]] > perm._components[Ze_signum_indices[j]])
			sig  = -sig;	
	}
	return sig;
}
...
int main() {
	...
	std::cout << "---\n";
	std::cout << "Ze signum: " << Ze_signum(cube) << '\n';
